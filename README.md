...
```
git clone https://github.com/Al-tsao/Restaurant_List_Project.git
```
...
5. 安裝 express & express-handlebars 套件
...
```
Restaurant List Project Go live
```
